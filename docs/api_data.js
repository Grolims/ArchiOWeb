define({ "api": [
      ...
      "fields": {
        "Response body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "userId",
            "description": "<p>The ID of the creator of the item</p>"
          },
          {
            "group": "Response body",
            "type": "Date",
            "optional": false,
            "field": "creationDate",
            "description": "<p>The creation's date of the item</p>"
          },
          {
            "group": "Response body",
            "type": "Date",
            "optional": false,
            "field": "lastModified",
            "description": "<p>The date of the last modification of the item</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Response body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "creationDate",
            "description": "<p>The creation's date of the salepoint</p>"
          },
          {
            "group": "Response body",
            "type": "Date",
            "optional": false,
            "field": "lastModified",
            "description": "<p>The date of the last modification of the salepoint</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "group": "User",
    "version": "1.0.0",
    "description": "<p>Connect to an account</p>",
    "parameter": {
      "fields": {
        "Request body": [
          {
  ...
  },
  {
    ...
    "group": "User",
    "version": "1.0.0",
    "description": "<p>Retrieves one user with item add.</p>",
    "examples": [
      {
        "title": "Example",
