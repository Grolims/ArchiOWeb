...
/**
 * @api {patch} /api/items/:id Partially update a item
 ...
 *
 * @apiExample Example
 *     PATCH /api/items/619126a15f69d38480a2a49f HTTP/1.1
 *     Content-Type: application/json
 *
 *     {
 *       "price": 2
...
/**
 * @api {delete} /api/items/:id Delete a item
 * @apiName DeleteItem
 * @apiGroup Item
 * @apiVersion 1.0.0
